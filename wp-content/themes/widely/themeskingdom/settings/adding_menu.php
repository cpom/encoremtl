...
<select name="colorofbutton" class="colorofbutton" style="height: 24px;width: 200px !important;">
	...
	<option value="dark-blue">Dark Blue
...
<script type="text/javascript">
	jQuery('.colorofbutton').change(function(){
		...
		jQuery('.thepreviewbutton').css('background-image','url(<?php echo get_template_directory_uri().'/themeskingdom/style/img/button-'; ?>'+color+'.png)').css('background-position','left top').css('display','block');	
	});
...
<h1>Fullwidth</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere1two1"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere1two1"><br/>
...
<h1>Left Half</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere1two"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere1two"><br/>
...
<h1>Right Half</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere2two"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere2two"><br/>
...
<span style="float:left;">
<h1>First cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere1"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere1"><br/>
<label class='formlabel'>Cell Text:</label><br/><textarea name="celltexthere1" class="celltexthere1"></textarea><br/><br/>
</span>
<span style="float:left;">
<h1>Second cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere2"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere2"><br/>
...
<h1>Third cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere3"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere3"><br/>
...
<span style="float:left;">
<h1>First cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere1four"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere1four"><br/>
<label class='formlabel'>Cell Text:</label><br/><textarea name="celltexthere1four" class="celltexthere1four"></textarea><br/><br/>
</span>
<span style="float:left;">
<h1>Second cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere2four"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere2four"><br/>
<label class='formlabel'>Cell Text:</label><br/><textarea name="celltexthere2four" class="celltexthere2four"></textarea><br/><br/>
</span>
<span style="float:left;">
<h1>Third cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere3four"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere3four"><br/>
<label class='formlabel'>Cell Text:</label><br/><textarea name="celltexthere3four" class="celltexthere3four"></textarea><br/><br/>
</span>
<span style="float:left;" class="last">
<h1>Fourth cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere4four"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere4four"><br/>
...
<span style="float:left;">
<h1>First cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere1five"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere1five"><br/>
<label class='formlabel'>Cell Text:</label><br/><textarea name="celltexthere1five" class="celltexthere1five"></textarea><br/><br/>
</span>
<span style="float:left;">
<h1>Second cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere2five"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere2five"><br/>
<label class='formlabel'>Cell Text:</label><br/><textarea name="celltexthere2five" class="celltexthere2five"></textarea><br/><br/>
</span>
<span style="float:left;">
<h1>Third cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere3five"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere3five"><br/>
<label class='formlabel'>Cell Text:</label><br/><textarea name="celltexthere3five" class="celltexthere3five"></textarea><br/><br/>
</span>
<span style="float:left;">
<h1>fiveth cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere4five"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere4five"><br/>
<label class='formlabel'>Cell Text:</label><br/><textarea name="celltexthere4five" class="celltexthere4five"></textarea><br/><br/>
</span>
<span style="float:left;" class="last">
<h1>Fifth cell</h1>
<label class='formlabel'>Cell image url:</label><br/><input type="text" name="cellimagehere5five"><br/>
...
<label class='formlabel'>Cell SubTitle:</label><br/><input type="text" name="cellundertitlehere5five"><br/>
...
<input class="listtype" rel="ul" type="radio" name="listtype" value="5" style="float: left;margin: 10px 5px 0 0!important;width: 15px !important;"><label class='formlabel' style=" float: left;width: 15px !important;"><img src="<?php echo LISTSTYLE  ?>5.png" style="margin: 5px 0 0;"></label>
...
<script type="text/javascript">
	...
	jQuery("#formone").bind("keypress", function(e) {
			...
			jQuery('.listtext').append("<li>"+jQuery("#oneinlist").val()+"</li>");
...
jQuery(document).ready(function($) {
	...
	jQuery('.thepreviewbutton').css('background-image','url(<?php echo get_template_directory_uri().'/themeskingdom/style/img/button-default.png)'?>').css('background-position','left top').css('display','block');	
	...
	jQuery('.column1submit').click(function(){
		...
		if(cellimagehere1 !== ""){
			insert = insert + '[cell_image]'+cellimagehere1+'[/cell_image]\n';
		}
		if(celltitlehere1 !== ""){
		...
		if(cellundertitlehere1 !== ""){
			insert = insert + '[cell_subtitle]'+cellundertitlehere1+'[/cell_subtitle]';
		}
		if(celltitlehere1 !== ""){
			insert = insert + "\n[/titles]";
		}
	...
	jQuery('.column2submit').click(function(){
		...
		if(cellimagehere2 !== ""){
			insert = insert + '[cell_image]'+cellimagehere2+'[/cell_image]\n';
		}
		if(celltitlehere2 !== ""){
			insert = insert + '[titles]\n [cell_title ';
		...
		if(cellundertitlehere2 !== ""){
			insert = insert + '[cell_subtitle]'+cellundertitlehere2+'[/cell_subtitle]';
		}
	...
	jQuery('.column3submit').click(function(){
		...
		if(cellimagehere3 !== ""){
		 	insert = insert + '[cell_image]'+cellimagehere3+'[/cell_image]\n';
		}
		if(celltitlehere3 !== ""){
			insert = insert + '[titles]\n [cell_title ';
		...
		if(cellundertitlehere3 !== ""){
			insert = insert + '[cell_subtitle]'+cellundertitlehere3+'[/cell_subtitle]';
		}
	...
	jQuery('.column4submit').click(function(){
		...
		if(cellimagehere4 !== ""){
		 insert = insert + '[cell_image]'+cellimagehere4+'[/cell_image]\n';
		}
		...
		if(cellundertitlehere4 !== ""){
		insert = insert + '[cell_subtitle]'+cellundertitlehere4+'[/cell_subtitle]';
		}
		insert = insert + "\n[/titles]";
	...
	jQuery('.column5submit').click(function(){
		...
		if(cellimagehere5 !== ""){
		 insert = insert + '[cell_image]'+cellimagehere5+'[/cell_image]\n';
		}
		...
		if(cellundertitlehere5 !== ""){
		insert = insert + '[cell_subtitle]'+cellundertitlehere5+'[/cell_subtitle]';
		}
		insert = insert + "\n[/titles]";
...
<input type="button" class="addh2 tkbutton" value="Add H2 + Subtitle + Line">
