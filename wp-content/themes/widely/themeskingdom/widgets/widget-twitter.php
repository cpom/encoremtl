...
class App_Twitter extends WP_Widget {
   ...
   function App_Twitter() {
       ...
       parent::WP_Widget(false, __(THEME_NAME.' - Twitter Stream', THEME_NAME),$widget_ops);      
   }
   ...
   function form($instance) {        
       ...
       <p>
	   	  <label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Number of tweets:',THEME_NAME); ?></label>
