...
new function() {
     ...
     * jQBrowser plugin, accessed externally through the jQuery.browser object.
     * See the relevant function definition later in the source for further
     * information.
     *
     * jQuery.browser.browser()
     * jQuery.browser.version.number()
     * jQuery.browser.version.string()
     * jQuery.browser.OS()
     *
     * jQuery.browser.aol()
     * jQuery.browser.camino()
     * jQuery.browser.firefox()
     * jQuery.browser.flock()
     * jQuery.browser.icab()
     * jQuery.browser.konqueror()
     * jQuery.browser.mozilla()
     * jQuery.browser.msie()
     * jQuery.browser.netscape()
     * jQuery.browser.opera()
     * jQuery.browser.safari()
     *
     * jQuery.browser.linux()
     * jQuery.browser.mac()
     * jQuery.browser.win()
     */
    var Public = {
    ...
    // Allow external access to the 'Public' interface through the jQuery.browser
    // object.
    ...
    for( var  i = 0,                    // counter
        ...
        if( data[i].browser() ) { // we have a match
            ...
            // jQuery.browser.browser() will now return the correct browser.
    ...
    for( var  i = 0,                  // counter
       ...
       i++
        ...
        if( data[i].OS() ) { // we have a match
            ...
            // jQuery.browser.OS() will now return the correct OS.
